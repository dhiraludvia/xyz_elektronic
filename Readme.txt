...
They use Odoo to manage the process their business, especially in the purchasing (Purchase), 
sales (Sales), and inventory (Inventory) sections. 
...
- Asg4 module contain Report and Wizard for Inventory Module.
    To especially see the report for Booking Order, please EDIT the record that have been created in Delivery Orders Form 
    to make sure that boolean Booking Order is CHECKED. Because the field haven't done yet to automatic True, 
    but the report domain has been created to display booking order data only.
